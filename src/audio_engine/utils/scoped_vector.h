...
// Adapted for audio_engine: include paths changed from webrtc/ to utils/.

#ifndef UTILS_SCOPED_VECTOR_H_
#define UTILS_SCOPED_VECTOR_H_

#include <vector>

#include "utils/checks.h"
#include "utils/deprecation.h"
#include "utils/stl_util.h"

namespace webrtc {

// ScopedVector wraps a vector deleting the elements from its destructor.
template <class T>
class ScopedVector {
 public:
