...
// Adapted for audio_engine: include paths changed from webrtc/base/ to utils/.

#ifndef UTILS_SCOPED_PTR_H_
#define UTILS_SCOPED_PTR_H_
...
#include "utils/constructormagic.h"
#include "utils/deprecation.h"
#include "utils/template_util.h"
