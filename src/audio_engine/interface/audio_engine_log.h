 ...
 * @Author: Ryuk
 * @Date: 2026-08-11
 * @Description: Internal logging utilities — NOT part of the public API
 *               Include this only in .cpp implementation files.
 */
#ifndef AUDIO_ENGINE_LOG_H
#define AUDIO_ENGINE_LOG_H
