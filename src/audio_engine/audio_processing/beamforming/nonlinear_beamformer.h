...
// Fallback for FRIEND_TEST_ALL_PREFIXES when gtest is not available (library build).
#ifndef FRIEND_TEST_ALL_PREFIXES
#define FRIEND_TEST_ALL_PREFIXES(test_case_name, test_name) \
  friend class test_case_name##_##test_name##_Test
#endif

#include "signal_processing/lapped_transform.h"
#include "utils/channel_buffer.h"
#include "audio_processing/beamforming/beamformer.h"
#include "audio_processing/beamforming/complex_matrix.h"
#include "utils/scoped_vector.h"
