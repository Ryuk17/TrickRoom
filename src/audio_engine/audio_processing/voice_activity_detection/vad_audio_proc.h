...
#include "audio_processing/voice_activity_detection/common.h"  // AudioFeatures, kSampleR...
...
class VadAudioProc {
 ...
 private:
  ...
  // NE10 FFT config and temp buffer (replaces Ooura ip_/w_fft_)
  void* fft_cfg_;       // ne10_fft_r2c_cfg_float32_t
  float* fft_tmp_out_;  // (kDftSize/2 + 1) * 2 floats for NE10 output
