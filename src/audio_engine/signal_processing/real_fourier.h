...
// Adapted for audio_engine: include paths changed, NE10 used as FFT backend.

#ifndef SIGNAL_PROCESSING_REAL_FOURIER_H_
#define SIGNAL_PROCESSING_REAL_FOURIER_H_
...
#endif  // SIGNAL_PROCESSING_REAL_FOURIER_H_
